...
gohatch is licensed under the **European Union Public Licence v1.2 (EUPL-1.2)**.
...
For third-party licences (Go module dependencies), see [Third-Party Licenses](third-party-licenses.md).
